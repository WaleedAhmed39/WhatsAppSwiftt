...
open class RecordButton: UIButton, UIGestureRecognizerDelegate {
    ...
    private func setup() {
        ...
        if image(for: .normal) == nil {
            let image = UIImage(named: "mic_blue")!.withRenderingMode(.alwaysTemplate).getSizeImage(size: CGSize(width: 15, height: 15))
    ...
    open override func updateConstraints() {
        recordView.setUpRecorderLockViewConstraint(from: self)
